...
use crate::GameState;
use crate::game::{Asteroid, LivesRemanining};
...
fn display_hud(mut commands: Commands) {
    commands.spawn((
        ...
        children![
            TextSpan::new("Asteroids remaning: "),
            TextSpan::new("0"),
            TextSpan::new("\n"),
...
fn update_hud(
    ...
    lives_remaining: Res<LivesRemanining>,
) -> Result {
    ...
    *writer.text(text, 8) = format!("{}", duration.0.elapsed().as_secs());
